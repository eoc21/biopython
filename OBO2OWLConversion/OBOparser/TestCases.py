...
class ConvertOBO2OWL():
    ...
    def convertOBO2OWL(self,outputOWLFile):
        ...
        self.OWLOntology.docTypeDeclaration()
        f.write(self.OWLOntology.docTypeDec)
        self.OWLOntology.setXMLNameSpaceRDFConstruct()
        f.write(self.OWLOntology.rdfDeclarationOpen)
        self.OWLOntology.addOWLAnnotationPropertyHeaderInformation()
        f.write(self.OWLOntology.annotationProperties)
        ...
        f.write("<owl:Ontology rdf:about=\"#OBO\">"+"\n")
        f.write(self.OWLOntology.formatVersion)
        f.write(self.OWLOntology.date)
        f.write(self.OWLOntology.savedBy)
        f.write(self.OWLOntology.autoGeneratedBy)
        f.write(self.OWLOntology.defaultNameSpace)
        f.write(self.OWLOntology.nsIdRule)
        f.write(self.OWLOntology.remark)
        f.write(self.OWLOntology.typeRef)
        f.write(self.OWLOntology.version)
    ...
    def processHeaderArgument(self,headerArgument,headerInformation):
        ...
        if values[0] == "format-version":
            ...
            self.OWLOntology.formatVersion = headerInformation.format
        elif values[0] == "date":
...
if __name__ == "__main__":
    ...
    converter.convertOBO2OWL("/home/ed/Desktop/TestA.owl")
    #t1 = time.time()
    #elapsedTime = t1-t0
#print elapsedTime