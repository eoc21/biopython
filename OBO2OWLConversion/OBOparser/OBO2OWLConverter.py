...
class ConstantHeader():
    ...
    def convertAutoGeneratedBy(self, autoGenerated):
        ...
        """
        self.autoGenerated = "<mo:autoGenerationBy>"+autoGenerated+"</mo:autoGeneratedBy>"
...
class OWLOntology():
    ...
    def setXMLNameSpaceRDFConstruct(self):
        ...
        xmlns= "xmlns=\"http://www.polymerinformatics.com/PropertiesXOntology#\""
        ...
        xmlMO = "xmlns:mo="+"\"http://www.daml.org/2003/01/periodictable/PeriodicTable#\""
